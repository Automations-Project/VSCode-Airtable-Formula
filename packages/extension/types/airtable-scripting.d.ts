...
declare var input: {
    ...
    textAsync(label: string, options?: { placeholder?: string }): Promise<string>;
    ...
    tableAsync(label: string, options?: { shouldAllowCreatingTable?: boolean }): Promise<Table>;
    viewAsync(label: string, options: { parentTable: Table | string; shouldAllowCreatingView?: boolean }): Promise<View>;
    fieldAsync(label: string, options: { parentTable: Table | string }): Promise<Field>;
    ...
    fileAsync(label: string, options?: FileOption): Promise<File>;
};
